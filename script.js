document.addEventListener('DOMContentLoaded', () => {
    ...
    myForm.addEventListener('touchstart', async (event) => {
        ...
        if (event.target.type === 'submit') {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (window.confirm('Remessa enviada com sucesso. Clique em OK para continuar.')) {
                        // Redirecionar para a página inicial (index.html) após o OK ser clicado
